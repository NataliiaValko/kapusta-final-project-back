const prepareInvitationMail = (friendName, userName, APP_LINK) => {
  ...
  * {
  ...
  <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
      <p style="font-size: 14px; line-height: 140%; text-align: center;"><strong><span style="font-family: Cabin, sans-serif; font-size: 32px; line-height: 44.8px;">Hello, dear ${friendName}!</span></strong></p>
    </div>
  ...
  <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div style="line-height: 140%; text-align: center; word-wrap: break-word;">
      <p style="font-size: 14px; line-height: 140%; text-align: center;"><span style="font-family: Cabin, sans-serif; font-size: 20px; line-height: 28px;">${userName} invites you </span><br /><span style="font-family: Cabin, sans-serif; font-size: 20px; line-height: 28px;">to enjoy our <strong>Kapu<span style="font-size: 16px; line-height: 22.4px;">$</span>ta App!</strong></span></p>
    </div>
  ...
  <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div style="color: #ffffff; line-height: 100%; text-align: center; word-wrap: break-word;">
      <p style="line-height: 100%; font-size: 14px;"><span style="color: #000000; font-family: Cabin, sans-serif; font-size: 14px; line-height: 14px;"><span style="font-size: 34px; line-height: 34px;"><span style="font-size: 20px; line-height: 20px;">Please, click the button below to join it! Thank you!</span></span></span></p>
    </div>
  ...
  <div align="center">
    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;font-family:'Montserrat',sans-serif;"><tr><td style="font-family:'Montserrat',sans-serif;" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${APP_LINK}" style="height:47px; v-text-anchor:middle; width:102px;" arcsize="34%" stroke="f" fillcolor="#ff751d"><w:anchorlock/><center style="color:#ffffff;font-family:'Montserrat',sans-serif;"><![endif]-->
      <a href="${APP_LINK}" target="_blank" style="box-sizing: border-box;display: inline-block;font-family:'Montserrat',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #ff751d; border-radius: 16px;-webkit-border-radius: 16px; -moz-border-radius: 16px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
        <span style="display:block;padding:12px 34px;line-height:117%;"><span style="font-family: Cabin, sans-serif;"><span style="font-size: 20px; line-height: 23.4px;">GO!</span></span><br /></span>
      </a>
...
module.exports = { prepareInvitationMail };
